...
class Unitsync:
	...
	def __init__(self, location):
		...
		self._init("GetSysInfoHash", c_char_p)
		self._init("GetMacAddrHash", c_char_p)
	...
	def GetSysInfoHash(self): return self.unitsync.GetSysInfoHash()
	def GetMacAddrHash(self): return self.unitsync.GetMacAddrHash()
